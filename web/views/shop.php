...
<div class="container">
    ...
    <div class="col-sm-4 col-md-3">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>?action=add&id=1">
            <div class="products">
                ...
                <input type="submit" name="add_to_cart" class="btn btn-info addbtn" id="caketopper1" value="add to cart">
            </div>
        </form>
    </div>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>?action=add&id=2">
            <div class="products">
                ...
                <input type="submit" name="add_to_cart" class="btn btn-info addbtn" id="caketopper2" value="add to cart">
            </div>
        </form>
    </div>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>?action=add&id=3">
            <div class="products">
                ...
                <input type="submit" name="add_to_cart" class="btn btn-info addbtn" id="centerpiece" value="add to cart">
            </div>
        </form>
    </div>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>?action=add&id=4">
            <div class="products">
                ...
                <input type="submit" name="add_to_cart" class="btn btn-info addbtn" id="rock" value="add to cart">
            </div>
        </form>
    </div>
